...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#000814] border-t border-white/10 pt-16 pb-8 font-inter">
      <div className="max-w-7xl mx-auto px-6">
        
        {/* Top Section: Brand & Newsletter */}
        <div className="flex flex-col lg:flex-row justify-between gap-12 mb-16">
          <div className="lg:w-1/3">
        <Link to="/" className="flex py-5 items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-white">Chat<span className="text-indigo-400">Flow</span></span>
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              The world’s fastest and most secure messaging platform. 
              Connecting people across the globe with end-to-end encryption.
            </p>
            {/* Social Icons (SVGs) */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-b border-white/5 pb-12">
          <div>
            <h5 className="text-white font-bold mb-4 uppercase text-xs tracking-widest">Product</h5>
            <ul className="space-y-3 text-gray-500 text-sm">
              <li><a href="#" className="hover:text-indigo-400 transition-colors">Features</a></li>
              <li><a href="#" className="hover:text-indigo-400 transition-colors">Security</a></li>
              <li><a href="#" className="hover:text-indigo-400 transition-colors">Business</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-600 text-xs">
          <p>© {currentYear} ChatWave Inc. All rights reserved.</p>
          <div className="flex gap-6">
            <span>Made with <span className="text-red-500">♥</span> for the future.</span>
          </div>
        </div>
      </div>
    </footer>
